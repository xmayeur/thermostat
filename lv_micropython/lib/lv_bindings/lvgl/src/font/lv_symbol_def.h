...
#define LV_SYMBOL_GEAR	           "\xef\x82\x85" /*61573, 0xF085*/
#define LV_SYMBOL_SUN	           "\xef\x86\x85" /*61829, 0xF185*/
#define LV_SYMBOL_MOON	           "\xef\x86\x86" /*61830, 0xF186*/
#define LV_SYMBOL_THERMOMETER     "\xef\x8B\x88" /*62152, 0xF2C8*/
#define LV_SYMBOL_CALENDAR        "\xef\x9E\x84" /*63364, 0xF784*/
...
enum {
    ...
    _LV_STR_SYMBOL_SUN,
    _LV_STR_SYMBOL_MOON,
    _LV_STR_SYMBOL_THERMOMETER,
    _LV_STR_SYMBOL_CALENDAR,
